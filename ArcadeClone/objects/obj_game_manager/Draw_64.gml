...
var height = 35;
draw_text(room_width/4,height,"" + string(total_points));
draw_set_halign(fa_center);
draw_text(room_width/2,height,"" + string(high_score));
	...
	switch(end_step){
		...
		case 2: //show points + cities
			...
			if(step_timer>0){
				...
				step_timer=5;
				if(cur_city >= 6){
					total_points+= num_bonus_cities*100;
					step_timer=60;
					end_step = 3;
				}
			}
